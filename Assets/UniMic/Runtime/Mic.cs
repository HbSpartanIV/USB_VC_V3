...
namespace Adrenak.UniMic {
    ...
    public class Mic : MonoBehaviour {
        ...
        private static readonly Dictionary<string, Device> deviceMap = new();
        ...
        private static void ClearDeviceData(Device device) {
            if (clips.ContainsKey(device)) {
        ...
        private static Dictionary<Device, AudioClip> clips = new();
        private static Dictionary<Device, int> prevPositions = new();
        private static Dictionary<Device, Queue<float>> pcms = new();
        ...
        private void Update() {
            foreach (var pair in clips) {
                ...
                if (!didLoop) {
                    ...
                    var lastLoopSampleLen = clip.samples - prevPos - 1;
                    var currLoopSampleLen = pos + 1;
